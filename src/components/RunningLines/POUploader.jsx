...
import { detectTariffsForParsedPOs } from "../../utils/poTariffDetection";
...
export default function POUploader({ direction = "forward", onUploaded }) {
  ...
  async function detectTariffsForPOs(pos) {
    ...
    // for every distinct po_date in this batch. The reference lock lives at
    // PO date + 3 business days (Signet's lock rule), so fetch a RANGE.
